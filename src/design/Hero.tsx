...
export const BackgroundCircles = ({ parallaxRef }: { parallaxRef: any }) => {
    ...
    return (
        <div className="absolute -top-[28rem] left-1/2 hidden sm:flex sm:w-[620px] md:w-[750px] lg:w-[1000px]  xl:w-[78rem] aspect-square border border-n-2/5 rounded-full -translate-x-1/2 sm:-top-[0rem] md:-top-[0rem] xl:-top-[0rem] -z-10">
            <Rings />
